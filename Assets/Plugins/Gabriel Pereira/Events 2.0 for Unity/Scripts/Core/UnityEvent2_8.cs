...
{
	public delegate void UnityAction<T0, T1, T2, T3, T4, T5, T6, T7>(T0 arg0, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7);

	/// <summary>
	/// Events 2.0 for Unity with eight generic types
	/// </summary>
	[System.Serializable]
	public abstract class UnityEvent2<T0, T1, T2, T3, T4, T5, T6, T7> : UnityEventBase2
	{
		...
		{
			return GetValidMethodInfo(targetObj, name, new System.Type[8] { typeof(T0), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7) });
		}

		internal override BaseInvokableCall2 GetDelegate(object target, MethodInfo theFunction)
		{
			return new InvokableCall2<T0, T1, T2, T3, T4, T5, T6, T7>(target, theFunction);
		}

		private static BaseInvokableCall2 GetDelegate(UnityAction<T0, T1, T2, T3, T4, T5, T6, T7> action)
		{
			return new InvokableCall2<T0, T1, T2, T3, T4, T5, T6, T7>(action);
		}
		...
		public void Invoke(T0 arg1, T1 arg2, T2 arg3, T3 arg4, T4 arg5, T5 arg6, T6 arg7, T7 arg8)
		{
			...
			{
				var curCall = calls[i] as InvokableCall2<T0, T1, T2, T3, T4, T5, T6, T7>;
				if (curCall != null)
		...
		internal void AddPersistentListener(UnityAction<T0, T1, T2, T3, T4, T5, T6, T7> call, UnityEventCallState callState)
		{
