...
{
	[AddComponentMenu("UI/Slider 2.0", 34)]
	[RequireComponent(typeof(RectTransform))]
	public class Slider2 : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
	{
		[Serializable]
		public class Slider2Event : UnityEvent2<float> { }

		[SerializeField]
		private RectTransform m_FillRect;
		public RectTransform fillRect { get { return m_FillRect; } set { if (SetPropertyUtility2.SetClass(ref m_FillRect, value)) { UpdateCachedReferences(); UpdateVisuals(); } } }
		...
		public Slider.Direction direction { get { return m_Direction; } set { if (SetPropertyUtility2.SetStruct(ref m_Direction, value)) UpdateVisuals(); } }

		[SerializeField]
		private float m_MinValue = 0;
		public float minValue { get { return m_MinValue; } set { if (SetPropertyUtility2.SetStruct(ref m_MinValue, value)) { Set(m_Value); UpdateVisuals(); } } }

		[SerializeField]
		private float m_MaxValue = 1;
		public float maxValue { get { return m_MaxValue; } set { if (SetPropertyUtility2.SetStruct(ref m_MaxValue, value)) { Set(m_Value); UpdateVisuals(); } } }

		[SerializeField]
		private bool m_WholeNumbers = false;
		public bool wholeNumbers { get { return m_WholeNumbers; } set { if (SetPropertyUtility2.SetStruct(ref m_WholeNumbers, value)) { Set(m_Value); UpdateVisuals(); } } }
		...
		private Slider2Event m_OnValueChanged = new Slider2Event();
		public Slider2Event onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
