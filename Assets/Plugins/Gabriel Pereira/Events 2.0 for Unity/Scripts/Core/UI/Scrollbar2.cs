...
{
	[AddComponentMenu("UI/Scrollbar 2.0", 35)]
	[RequireComponent(typeof(RectTransform))]
	public class Scrollbar2 : Selectable, IBeginDragHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
	{
		[Serializable]
		public class Scroll2Event : UnityEvent2<float> { }

		[SerializeField]
		private RectTransform m_HandleRect;
		public RectTransform handleRect { get { return m_HandleRect; } set { if (SetPropertyUtility2.SetClass(ref m_HandleRect, value)) { UpdateCachedReferences(); UpdateVisuals(); } } }

		// Scrollbar.Direction of movement.
		[SerializeField]
		private Scrollbar.Direction m_Direction = Scrollbar.Direction.LeftToRight;
		public Scrollbar.Direction direction { get { return m_Direction; } set { if (SetPropertyUtility2.SetStruct(ref m_Direction, value)) UpdateVisuals(); } }

		protected Scrollbar2()
		{ }
		...
		public float size { get { return m_Size; } set { if (SetPropertyUtility2.SetStruct(ref m_Size, Mathf.Clamp01(value))) UpdateVisuals(); } }
		...
		public int numberOfSteps { get { return m_NumberOfSteps; } set { if (SetPropertyUtility2.SetStruct(ref m_NumberOfSteps, value)) { Set(m_Value); UpdateVisuals(); } } }

		[Space(6)]

		// Allow for delegate-based subscriptions for faster events than 'eventReceiver', and allowing for multiple receivers.
		[SerializeField]
		[Tooltip("Events to trigger when this scrollbar value is changed")]
		private Scroll2Event m_OnValueChanged = new Scroll2Event();
		public Scroll2Event onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
		...
		Axis axis { get { return (m_Direction == Scrollbar.Direction.LeftToRight || m_Direction == Scrollbar.Direction.RightToLeft) ? Axis.Horizontal : Axis.Vertical; } }
		bool reverseValue { get { return m_Direction == Scrollbar.Direction.RightToLeft || m_Direction == Scrollbar.Direction.TopToBottom; } }
