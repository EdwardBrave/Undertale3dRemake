...
namespace UnityEngine.UI
{
	...
	/// </summary>
	[AddComponentMenu("UI/Toggle 2.0", 31)]
	[RequireComponent(typeof(RectTransform))]
	public class Toggle2 : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
	{
		[Serializable]
		public class Toggle2Event : UnityEvent2<bool> { }
		...
		/// </summary>
		[Tooltip("Events to trigger when this toggle value is changed")]
		public Toggle2Event onValueChanged = new Toggle2Event();
		...
		private void SetToggleGroup(ToggleGroup2 newGroup, bool setMemberValue)
		{
			ToggleGroup2 oldGroup = m_Group;
