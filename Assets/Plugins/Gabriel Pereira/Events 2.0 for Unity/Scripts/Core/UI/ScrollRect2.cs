...
{
	[AddComponentMenu("UI/Scroll Rect 2.0", 38)]
	[SelectionBase]
	[ExecuteInEditMode]
	...
	{
		[Serializable]
		public class ScrollRect2Event : UnityEvent2<Vector2> { }
		...
		public ScrollRect.MovementType movementType { get { return m_MovementType; } set { m_MovementType = value; } }

		[SerializeField]
		private float m_Elasticity = 0.1f; // Only used for ScrollRect.MovementType.Elastic
		...
		[SerializeField]
		private Scrollbar2 m_HorizontalScrollbar;
		public Scrollbar2 horizontalScrollbar
		{
			get
			{
		...
		[SerializeField]
		private Scrollbar2 m_VerticalScrollbar;
		public Scrollbar2 verticalScrollbar
		{
			get
			{
		...
		public ScrollRect.ScrollbarVisibility horizontalScrollbarVisibility { get { return m_HorizontalScrollbarVisibility; } set { m_HorizontalScrollbarVisibility = value; SetDirtyCaching(); } }

		[SerializeField]
		private ScrollRect.ScrollbarVisibility m_VerticalScrollbarVisibility;
		public ScrollRect.ScrollbarVisibility verticalScrollbarVisibility { get { return m_VerticalScrollbarVisibility; } set { m_VerticalScrollbarVisibility = value; SetDirtyCaching(); } }
		...
		[SerializeField]
		[Tooltip("Events to trigger when this scroll view horizontal and vertical values are changed")]
		private ScrollRect2Event m_OnValueChanged = new ScrollRect2Event();
		public ScrollRect2Event onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
		...
		void UpdateCachedData()
		{
			...
			m_HSliderExpand = allAreChildren && m_HorizontalScrollbarRect && horizontalScrollbarVisibility == ScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport;
			m_VSliderExpand = allAreChildren && m_VerticalScrollbarRect && verticalScrollbarVisibility == ScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport;
		...
		private static void UpdateOneScrollbarVisibility(bool xScrollingNeeded, bool xAxisEnabled, ScrollRect.ScrollbarVisibility scrollbarVisibility, Scrollbar2 scrollbar)
		{
			if (scrollbar)
			{
